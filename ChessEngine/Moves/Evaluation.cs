namespace MonoChess
{
    internal static class Evaluation
    {
        ...
        internal static void EvaluateBoardScore(ChessBoard board)
        {
            board.Score = 0;
            bool insufficientMaterial = true;

            if (board.blackInMate)
            {
                board.Score = 32767;
                return;
            }
            if (board.whiteInMate)
            {
                board.Score = -32767;
                return;
            }
